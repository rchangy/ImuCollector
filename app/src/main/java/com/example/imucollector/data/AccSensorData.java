...
@Entity(tableName = "acc data")
public class AccSensorData extends SensorData{

    public final double x;
    public final double y;
    public final double z;

    public AccSensorData(long timestamp, int recordId, int sessionId, double x, double y, double z){
